...
const createWSTestServer = require("./createWSTestServer");
 ...
 */
async function createSocketClient(port, closeAfter, room) {
...
module.exports = { startServer, waitForSocketState, createSocketClient };
